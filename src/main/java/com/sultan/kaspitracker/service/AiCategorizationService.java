...
public class AiCategorizationService {
    ...
    public Category categorizeMerchant(String merchantName) {
        ...
        try {
            try {
                log.info("Applying rate limit delay of 6 seconds...");
                Thread.sleep(6000);
            ...
            String aiResponse = chatModel.call(new org.springframework.ai.chat.prompt.Prompt(promptText, org.springframework.ai.openai.OpenAiChatOptions.builder().withModel("gemini-2.5-flash-lite").build())).getResult().getOutput().getContent();
